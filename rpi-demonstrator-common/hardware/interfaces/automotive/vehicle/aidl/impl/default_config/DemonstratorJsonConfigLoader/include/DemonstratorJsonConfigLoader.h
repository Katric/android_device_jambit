#ifndef android_hardware_automotive_vehicle_aidl_impl_default_config_DemonstratorJsonConfigLoader_include_JsonConfigLoader_H_
#define android_hardware_automotive_vehicle_aidl_impl_default_config_DemonstratorJsonConfigLoader_include_JsonConfigLoader_H_
...
class JsonConfigParser {
  ...
  private:
    ...
    JsonConfigLoader mSystemJsonConfigLoader;
...
class DemonstratorJsonConfigLoader final {
  public:
    DemonstratorJsonConfigLoader();
  ...
  private:
    std::unique_ptr<demonstratorjsonconfigloader_impl::JsonConfigParser> mParser;
};
...
#endif  // android_hardware_automotive_vehicle_aidl_impl_default_config_DemonstratorJsonConfigLoader_include_JsonConfigLoader_H_
