...
template <class T>
class VendorConstantParser final : public ConstantParserInterface {
  public:
    VendorConstantParser() {
...
JsonValueParser::JsonValueParser() {
    ...
    mConstantParsersByType["AmbientLightMode"] = std::make_unique<VendorConstantParser<AmbientLightMode>>();
    mConstantParsersByType["VehicleProperty"] = std::make_unique<ConstantParser<VehicleProperty>>();
    mConstantParsersByType["VendorVehicleProperty"] = std::make_unique<VendorConstantParser<VendorVehicleProperty>>();
